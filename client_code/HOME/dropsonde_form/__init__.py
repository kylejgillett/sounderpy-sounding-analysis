from ._anvil_designer import dropsonde_formTemplate
from anvil import *
import anvil.server


class dropsonde_form(dropsonde_formTemplate):
  def __init__(self, **properties):
    # Set Form properties and Data Bindings.
    self.init_components(**properties)

  def drops_all_profiles_button_click(self, **event_args):
  ...
  def dropsonde_button_click(self, **event_args):
    """This method is called when the button is clicked"""
